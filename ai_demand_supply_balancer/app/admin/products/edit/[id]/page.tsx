...
import { ArrowLeft, Save, Upload, X, QrCode } from 'lucide-react';
            ...
            <AnimatePresence>
                {saving && (
                    ...
                    >
                        ...
                        >
                            {success ? 'Product Updated Successfully!' : 'Saving Changes...'}
                        </motion.p>
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <main className="p-10 max-w-5xl mx-auto">
                ...
                >
                    ...
                    <header className="mb-12">
                        <h1 className="text-4xl font-light text-gray-800 dark:text-white tracking-tight mb-2">Edit Product</h1>
                        <p className="text-gray-400 dark:text-gray-500">Modify the details of your inventory item.</p>
                    </header>
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                                ...
                                <div className="space-y-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <input
                                            type="text"
                                            required
                                            className="bg-gray-50 dark:bg-[#1a1a1a] border-none rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#fdf2ef] dark:focus:ring-[#2a1e1a] text-gray-800 dark:text-white font-medium"
                                            value={formData.name}
                        ...
                        <div className="space-y-8">
                            ...
                            <button
                                type="submit"
                                disabled={saving}
                                className="w-full bg-[#d98a6c] hover:bg-[#c47659] text-white py-4 rounded-2xl font-bold shadow-xl shadow-[#d98a6c33] hover:translate-y-[-2px] active:translate-y-[0] transition-all flex items-center justify-center gap-3"
                            >
